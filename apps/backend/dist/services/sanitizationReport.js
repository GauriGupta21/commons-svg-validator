...
exports.generateSanitizationReport = generateSanitizationReport;
function generateSanitizationReport(original, sanitized) {
    const report = {
    ...
    report.reductionPercent =
        Math.round(((report.originalSize
            -
